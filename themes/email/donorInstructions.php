...
<?php $loginUrl = $data['loginUrl'] ?? ''; ?>
<a href="<?=htmlspecialchars($loginUrl !== '' ? $loginUrl : ($data['baseUrl'] ?? '/'), ENT_QUOTES)?>" style="padding: 8px;border-radius: 8px;background: #2700EB;text-decoration: none;color: #FFF;font-weight: 700;"><?=$this->t('Prijavi se')?></a>
