    ...
    <div id="sidebar" class="active">
        ...
        <div id="sidebarEntityContent" class="sidebarContent">
            ...
            <div id="statuses" data-module="status">
                ...
                <label>
                    <input type="radio" class="input" name="status" value="0">
                    <span class="statusNameContainer">
                            <span class="statusName">New</span>
                            <span class="description">Newly created, not yet worked on.</span>
                        </span>
                </label>
            </div>
            ...
            <div class="sidebarContentSection" data-module="loginProtected">
                <div class="sidebarContentSectionHandle">
                    <span><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M240-80q-33 0-56.5-23.5T160-160v-400q0-33 23.5-56.5T240-640h40v-80q0-83 58.5-141.5T480-920q83 0 141.5 58.5T680-720v80h40q33 0 56.5 23.5T800-560v400q0 33-23.5 56.5T720-80H240Zm0-80h480v-400H240v400Zm296.5-143.5Q560-327 560-360t-23.5-56.5Q513-440 480-440t-56.5 23.5Q400-393 400-360t23.5 56.5Q447-280 480-280t56.5-23.5ZM360-640h240v-80q0-50-35-85t-85-35q-50 0-85 35t-35 85v80ZM240-160v-400 400Z"/></svg>Protection</span>
                ...
                <div class="sidebarContentSectionContent">
                    <label>
                        <input type="checkbox" id="loginProtected" class="input">
                        <span><?=$this->t('Login Protected')?></span>
                    </label>
                </div>
            </div>
            <div class="sidebarContentSection" data-module="languageCode">
...
<script src="<?=ADMIN_ASSET_URL .'/js/page/page.js?v=1.0.2'?>" type="module"></script>
</body>
</html>